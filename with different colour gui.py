...
class VirusScannerApp:
    def __init__(self):
        self.company_name_path = "logo.png"  # Provide the path to your company name image here
        self.logo_path = "logo.jpg"  # Provide the path to your logo image here

        # Define the background color
        bg_color = "#aa1f2e"

        self.layout = [
            [sg.Image(key="-COMPANY_NAME-"), sg.Text("ALL DEFENCE", font=("Helvetica", 16), justification='center', text_color="white")],
            [sg.Image(key="-LOGO-", pad=(50, 0))],  # Logo image placeholder
            ...
            [sg.Button("Upload File", key="-UPLOAD-", size=(20, 1), font=("Helvetica", 12)),
            ...
            [sg.Text("", key="_OUTPUT_", size=(60, 20), font=("Helvetica", 12), text_color="white")],  # Output text area
            [sg.Button("Clear Output", key="-CLEAR-", size=(20, 1), font=("Helvetica", 12)),
             sg.Button("Exit", key="-EXIT-", size=(20, 1), font=("Helvetica", 12))]
        ]

        self.window = sg.Window("Suraj Supreme - Virus Scanner", self.layout, finalize=True, background_color=bg_color)
